...
?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Return Confirmation Details</h4>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        inner join tblcustomerlogin o on b.customerid=o.customerid inner join tblrentdetails r on b.powertoolid=r.powertoolid where r.rent_status='On rent'");
                        while($display=mysqli_fetch_array($sql))
                        
                        {
                        $_SESSION['powertoolprice']=$display['powertoolprice'];
                        $_SESSION['custid']=$display['customerid'];
                        $_SESSION['bookid']=$display['bookingid'];
                        $_SESSION['toolid']=$display['powertoolid'];
                        $_SESSION['fdate']=$display['fromdate'];
                        $_SESSION['adv_amount']=$display['adv_amount'];
                        $_SESSION['rent_stock']=$display['quantity'];
                        ?>
                      ...
                      <td><?php echo $s++ ?></td>
                        ...
                        <td><a href="returnform.php?re_id=<?php echo $display['rentid']; ?>"><button type="button" class="btn btn-outline-primary">Return Confirmation</button></a></td>
                      </tr>
                      <?php } ?>
