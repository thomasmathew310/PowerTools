...
<div class="logo">
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">LOCATION REPORT</h2>
...
include("config.php");
$s=1;
$sql="select districtname,locationname from tbldistrict de inner join tbllocation d on de.districtid=d.districtid";
