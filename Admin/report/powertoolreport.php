...
include("config.php");
$s=1;
$sql="select de.categoryname,d.* from tblpowertool d inner join tblpowertoolcategory de on d.powertoolcategory=de.categoryid";
